  ...
  <div>
    ...
    <div class="el-breadcrumb">
      ...
      <el-breadcrumb separator-class="el-icon-arrow-right" style="top: 10px">
        ...
        <el-breadcrumb-item>社区服务 | 潜力协作</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    ...
    <div class="recommendPart">
      <div class="flip"
           @click="function (){gotoPro(tableData[0].tid)}">
        <div class="front"
        ...
        <div class="back">
          ...
          <b>简介：</b><p style="display: inline-block">{{ this.tableData[0].intro }}</p><br>
          <b>步骤：</b><p>{{ this.tableData[0].procedure }}</p>
        </div>
      </div>

      <div class="flip"
           @click="function (){gotoPro(tableData[1].tid)}">
        <div class="front"
        ...
        <div class="back">
          <h2>{{ this.tableData[1].name }}</h2>
           <b>简介：</b><p style="display: inline-block">{{ this.tableData[1].intro }}</p><br>
          <b>步骤：</b><p>{{ this.tableData[1].procedure }}</p>
        </div>
      </div>

      <div class="flip"
           @click="function (){gotoPro(tableData[2].tid)}">
        <div class="front"
        ...
        <div class="back">
          <h2>{{ this.tableData[2].name }}</h2>
           <b>简介：</b><p style="display: inline-block">{{ this.tableData[2].intro }}</p><br>
          <b>步骤：</b><p>{{ this.tableData[2].procedure }}</p>
        </div>
      </div>
    </div>
    <br><br><br>
    <div class="recommendPart2">
      <div class="flip"
           @click="function (){gotoPro(tableData[3].tid)}">
        <div class="front"
        ...
        <div class="back">
          <h2>{{ this.tableData[3].name }}</h2>
           <b>简介：</b><p style="display: inline-block">{{ this.tableData[3].intro }}</p><br>
          <b>步骤：</b><p>{{ this.tableData[3].procedure }}</p>
        </div>
      </div>

      <div class="flip"
           @click="function (){gotoPro(tableData[4].tid)}">
        <div class="front"
        ...
        <div class="back">
          <h2>{{ this.tableData[4].name }}</h2>
           <b>简介：</b><p style="display: inline-block">{{ this.tableData[4].intro }}</p><br>
          <b>步骤：</b><p>{{ this.tableData[4].procedure }}</p>
        </div>
      </div>

      <div class="flip"
           @click="function (){gotoPro(tableData[5].tid)}">
        <div class="front"
        ...
        <div class="back">
          <h2>{{ this.tableData[5].name }}</h2>
           <b>简介：</b><p style="display: inline-block">{{ this.tableData[5].intro }}</p><br>
          <b>步骤：</b><p>{{ this.tableData[5].procedure }}</p>
        </div>
      </div>
...
<script>
import {getBadProjects} from "@/api/recommend";
import {deviceMap} from "@/main";

export default {
  name: "community-side2",
  async mounted() {
    ...
    console.log("uid:" + uid);
    const res = await getBadProjects(uid, token);
  ...
  methods: {
    projectTransferAndAdd(report) {
      ...
      this.tableData.push({
        ...
        uid: report.uid,
        name: report.bugName,
        testDevice: deviceMap[report.testDevice],
        intro: report.bugDescription,
        procedure:report.bugProcedure,
      });
      console.log(this.tableData[0])
    },
    gotoPro(pid) {
      if (this.$store.state.role === 'WORKER' || this.$store.state.role === 'ADMIN') {
        this.$router.push(`/reportManage/${pid}`);
